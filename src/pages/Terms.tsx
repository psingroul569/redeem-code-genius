...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Permanent Ban', desc: 'Repeated or serious violations can result in a permanent removal from the site.' },
      { name: 'Legal Action', desc: 'In severe cases, we may involve relevant authorities or pursue legal remedies.' },
    ],
    footer: 'If you believe a ban was applied unfairly, you can appeal by contacting us within 30 days. We review all appeals honestly and our final decision stands.',
  },
  {
    icon: BookOpen,
  ...
  },
  {
    ...
    footer: 'The latest version will always be on this page. If you keep using the site after an update, that means you accept the revised terms.',
  },
];
    ...
    <main className="max-w-4xl mx-auto px-4 md:px-8 py-16">
      ...
      <div className="mb-12">
        ...
        <p className="text-t-muted text-sm leading-relaxed max-w-2xl">
          These terms cover how you can use freefireredeemcodetoday.com. We have written them as
          plainly as possible so there are no surprises. Please read through before using the site.
        </p>
        ...
        {sections.map((s) => {
          ...
          return (
            ...
            >
              ...
              {/* Body */}
              {s.body && (
                <p className="text-t-muted text-sm leading-relaxed mb-4">{s.body}</p>
              )}
              ...
              {/* Footer note */}
              {s.footer && (
                <p className="text-t-muted/70 text-xs leading-relaxed mt-4 pt-4 border-t border-border">
                  {s.footer}
                </p>
              )}
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-t-muted text-sm leading-relaxed">
              These Terms are governed by the laws of the jurisdiction in which we operate. Any
              disputes arising from your use of this website will be resolved through binding
              arbitration or in the appropriate courts, depending on the nature of the dispute.
            </p>
          </div>
        </div>
      </div>
