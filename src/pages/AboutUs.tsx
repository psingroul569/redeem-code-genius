...
const AboutUs = () => (
  <div className="min-h-screen bg-background text-foreground font-tech">
    ...
    <main className="max-w-4xl mx-auto px-4 md:px-8 py-16">
      ...
      <h1 className="text-3xl md:text-4xl font-display uppercase tracking-tight text-foreground mb-6">About Us</h1>
      <p className="text-t-muted leading-relaxed">About us content coming soon.</p>
    </main>
    <Footer />
  </div>
);
