...
export const Schema: React.FC<SchemaProps> = ({ currentView, selectedCode }) => {
  ...
  const liveBlogSchema = {
    ...
    "author": { "@type": "Person", "name": "Alex Mercer", "jobTitle": "Lead Rewards Analyst", "url": DEFAULT_URL },
  ...
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "itemListElement": [
      { "@type": "ListItem", "position": 1, "name": "Free Fire Rewards", "item": DEFAULT_URL },
      { "@type": "ListItem", "position": 2, "name": "Today's Codes", "item": `${DEFAULT_URL}/#codes` }
    ]
  };
