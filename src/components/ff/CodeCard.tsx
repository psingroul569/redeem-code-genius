    ...
    >
      ...
      <div className="mb-4 bg-white/5 rounded-xl p-3 border border-white/5 group-hover:border-cyber-success/30 transition-colors relative z-10">
        <div className="flex items-center justify-between">
            ...
            <button onClick={handleCopy} className={`ml-2 px-3 py-1.5 rounded-lg text-[9px] font-bold font-tech uppercase tracking-widest transition-all ${copied ? 'bg-cyber-success text-black' : 'bg-white/10 text-white hover:bg-white/20'}`}>
                {copied ? 'DONE' : 'COPY'}
            </button>
        </div>
      </div>
