      ...
      <div className="max-w-7xl mx-auto px-4 mb-12">
        ...
        <div className="flex flex-wrap justify-center items-center gap-x-10 gap-y-6 md:gap-x-16 opacity-30 grayscale hover:grayscale-0 transition-all duration-500 px-4">
          {["GAMINGWEEK", "ESPORTSDAILY", "FF WIKIA", "REDDIT", "DISCORD PRO"].map((brand) => (
            <span
              key={brand}
              className="text-base md:text-xl font-display text-white tracking-tighter whitespace-nowrap"
            >
              {brand}
            </span>
          ))}
      ...
      <div className="max-w-7xl mx-auto px-6 mb-12 border-b border-white/5 pb-12">
        <div className="grid grid-cols-3 lg:grid-cols-4 gap-y-12 gap-x-6 md:gap-x-16">
          <div className="col-span-3 lg:col-span-1 mb-4 lg:mb-0">
            <h3 className="font-display text-2xl md:text-3xl text-white mb-4 uppercase tracking-tight leading-none">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-cyber-success/80 font-bold uppercase tracking-widest">
                Global Sync Active
              </span>
            </div>
          </div>
          <div className="col-span-1">
            <h4 className="text-white font-bold text-sm md:text-base mb-6 tracking-[0.15em] uppercase border-b border-white/10 pb-2 inline-block">
              Resources
            </h4>
            <ul className="space-y-4 text-sm md:text-base text-cyber-muted">
              ...
              <li>
                <a href="#guide" className="hover:text-white transition-colors block">
                  Guide
                </a>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-4 text-sm md:text-base text-cyber-muted">
              ...
              <li className="text-[10px] md:text-xs text-cyber-muted/40 pt-1 tracking-widest uppercase">
